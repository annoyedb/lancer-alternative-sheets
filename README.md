...
* when registering new .hbs templates, or adding new elements existing templates, or making modification to localization files, it may be necessary to run `yarn build` yourself
