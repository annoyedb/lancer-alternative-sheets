<script lang="ts">
    ...
    import { getActorTokenSync, getImageOffsetX, getImageOffsetY, getImageWidth, getPilotSheetTooltipEnabled, setActorTokenSync, setImageOffsetXY, setImageWidth } from "@/scripts/pilot/settings";
...
<!-- Header -->
<div
    class="la-header-content -positionrelative -heightfull -overflowhidden"
    style="display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: auto auto auto; align-content: start;"
>
    ...
    <div
        class="-positionabsolute -widthhalf"
        style="right: 0; top: 0; z-index: 0;"
    >
