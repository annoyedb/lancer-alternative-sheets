<script lang="ts">
    ...
    function levelDown(event : MouseEvent)
    {
        event.stopPropagation();
        document.update({
            "system.sys": Math.max(system.sys - 1, 0), 
        })
    }
</script>
...
>
    ...
    <div class="la-combine-v -alignstart -padding1-b -heightfull">
        <GlyphButton
            ...
            tooltip={getLocalized("LA.pilot.systems.up.tooltip")}
        ...
        <GlyphButton
            ...
            tooltip={getLocalized("LA.pilot.systems.down.tooltip")}
            tooltipEnabled={tooltipEnabled}
            tooltipDirection={TooltipDirection.RIGHT}
