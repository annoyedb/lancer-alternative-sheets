<script lang="ts">
    ...
    function handleReorderCustomFlag(_event: DragEvent, dropData: { type: string, index: number }, thisData: { type: string, index: number })
    {
        if (dropData.type !== LADataType.Sorting)
            return;
        reorderCustomFlags(actor, CustomFlagKey.Mech, dropData.index, thisData.index);
    }
                            ...
                            >
                                <div class="la-combine-grid -horizontal2-auto -aligncenter -gap1 -widthfull">
                                    ...
                                    <input type="text" readonly
                                        ...
                                        value={getCustomFlagPath(CustomFlagKey.Mech, id, "value")}
                                    ...
                                    {#if flag.contentType === CustomFlagContentType.Fraction}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getCustomFlagPath(CustomFlagKey.Mech, id, "max")}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getCustomFlagPath(CustomFlagKey.Mech, id, "min")}
                            ...
                            >
                                <div class="la-combine-grid -horizontal2-auto -aligncenter -gap1 -widthfull">
                                    ...
                                    <input type="text" readonly
                                        ...
                                        ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                        : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                        value={getEnricher(actor.uuid, CustomFlagKey.Mech, id, "value")}
                                    ...
                                    {#if flag.contentType === CustomFlagContentType.Fraction}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getEnricher(actor.uuid, CustomFlagKey.Mech, id, "max")}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getEnricher(actor.uuid, CustomFlagKey.Mech, id, "min")}
