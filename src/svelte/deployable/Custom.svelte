<script lang="ts">
    ...
    {
        addCustomFlag(actor, CustomFlagKey.Deployable);
    }

    function handleDeleteCustomFlag(event: Event, actor: any, id: string)
    {
        event.stopPropagation();
        deleteCustomFlag(actor, CustomFlagKey.Deployable, id);
    }

    function handleUpdateCustomFlag(actor: any, id: string, changes: Partial<CustomFlag>)
    {
        updateCustomFlag(actor, CustomFlagKey.Deployable, id, changes);
    }
    ...
    function handleReorderCustomFlag(_event: DragEvent, dropData: { type: string, index: number }, thisData: { type: string, index: number })
    {
        if (dropData.type !== LADataType.Sorting)
            return;
        reorderCustomFlags(actor, CustomFlagKey.Deployable, dropData.index, thisData.index);
    }
        ...
        {#each flagEntries as [id, flag], index (id)}
            ...
            >
                <div class="la-generated -widthfull -gap1 la-flexcol">
                    ...
                    <EffectBox
                        name={getLocalized("LA.tab.custom.flag.sidebarToggle.deployable.label")}
                    >
                        <input type="checkbox"
                            class="-widthfull"
                            ...
                            >
                                <div class="la-combine-grid -horizontal2-auto -aligncenter -gap1 -widthfull">
                                    ...
                                    <input type="text" readonly
                                        ...
                                        value={getCustomFlagPath(CustomFlagKey.Deployable, id, "value")}
                                    ...
                                    {#if flag.contentType === CustomFlagContentType.Fraction}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getCustomFlagPath(CustomFlagKey.Deployable, id, "max")}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getCustomFlagPath(CustomFlagKey.Deployable, id, "min")}
                            ...
                            >
                                <div class="la-combine-grid -horizontal2-auto -aligncenter -gap1 -widthfull">
                                    ...
                                    <input type="text" readonly
                                        ...
                                        ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                        : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                        value={getEnricher(actor.uuid, CustomFlagKey.Deployable, id, "value")}
                                    ...
                                    {#if flag.contentType === CustomFlagContentType.Fraction}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getEnricher(actor.uuid, CustomFlagKey.Deployable, id, "max")}
                                        ...
                                        <input type="text" readonly
                                            ...
                                            ? 'la-brdr-darken-3 la-text-darken-7 la-bckg-darken-1'
                                            : 'la-brdr-lighten-3 la-text-lighten-7 la-bckg-lighten-1' }"
                                            value={getEnricher(actor.uuid, CustomFlagKey.Deployable, id, "min")}
