<script lang="ts">
    ...
    import ActionLogMessage from "@/svelte/shared/ActionLogMessage.svelte";
...
{#snippet headerSecondaryLeftOptions()}
    <i class="mdi mdi-message-text -fontsizemedium -padding0"></i>
{/snippet}
...
{#snippet headerSecondaryRightOptions()}
    <span class="-fontsizesmall">{extractedTimes[index]}</span>
{/snippet}
    <HeaderSecondary
