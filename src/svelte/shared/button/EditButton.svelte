...
<script lang="ts" module>
    export const HEADER_SECONDARY_STYLE = "la-prmy-header -glow-prmy la-scdy-primary -glow-scdy-hover -fontsize4";
    const _STYLE = "la-prmy-header -glow-prmy la-scdy-primary -glow-scdy-hover -fontsize4";
</script>
